...
public class WorldCamera implements KeyListener {
    ...
    public WorldCamera(Terrain terrain) {
        ...
        myAngle = 0;
        myTerrain = terrain;
        viewFrame = CoordFrame3D.identity().translate(myPos).translate(0, -1, 4);
    }
...
>>>>>>> parent of 93ea187... Merge branch 'jennifer'
        viewFrame = CoordFrame3D.identity().rotateY(myAngle);
        viewFrame = viewFrame.translate(myPos).translate(0, -1, 4);
